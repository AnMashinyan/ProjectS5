...
(function($){
	...
	$.supersized.vars = {
		...
		update_images 			: 	false,		// Trigger to update imgs after slide jump
	...
	$.supersized.defaultOptions = {
		...
		new_window				:	1,			// Img links open in new window/tab
		...
		// Size & Position
		fit_always				:	0,			// Img will never exceed browser width or height (Ignores min. dimensions)
		fit_landscape			:   0,			// Landscape imgs will not exceed browser width
		fit_portrait         	:   1,			// Portrait imgs will not exceed browser height
			...
			$(window).resize(function(){
				...
				if (api.options.progress_bar && !vars.in_animation){
					...
					if (!vars.progressDelay && api.options.slideshow){
						// Delay slideshow from resuming so Chrome can refocus imgs
